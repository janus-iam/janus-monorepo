...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-y border-dashed border-(--line) bg-(--header-bg) px-4 backdrop-blur-lg">
      <nav className="page-wrap flex flex-wrap justify-between items-center gap-x-3 gap-y-2 py-3 sm:py-4 border-x border-dashed border-(--line) page-wrap px-4">
